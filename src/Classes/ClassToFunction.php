...
namespace mPhpMaster\LaravelStart\Classes;

use Illuminate\Support\Traits\Tappable;
use mPhpMaster\LaravelStart\Traits\TMacroable;

/**
 * Class ClassToFunction
 * 
 * @package mPhpMaster\LaravelStart\Classes
 */
class ClassToFunction
{
    use Tappable,
    ...
    public function __construct()
    {
        ...
        if ( ($_f = new \Illuminate\Filesystem\Filesystem)->exists($path) ) {
            collect($_f->getRequire($path))->filter(function ($path, $class) {
                ...
                try {
                    ...
                    if ( $is_class ) {
                        ...
                        \mPhpMaster\LaravelStart\Classes\ClassToFunction::add($_class_name,
            ...
            eval(\mPhpMaster\LaravelStart\Classes\ClassToFunction::make());
        }
    }
