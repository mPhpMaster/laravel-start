...
if ( !function_exists('includeRoutesDir') ) {
    /**
     * Include Routes files
     *
     * @param string        $__DIR__
     * @param string        $__FILE__
     * @param callable|null $incCallBack
     *
     * @return \Illuminate\Support\Collection
     */
    function includeRoutesDir($__DIR__, $__FILE__ = "", callable $incCallBack = null)
    {
        return includeAllSubFiles($__DIR__, $__FILE__, $incCallBack);
    }
}
